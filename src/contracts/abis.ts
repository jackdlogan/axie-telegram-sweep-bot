/**
 * Smart contract ABIs for Axie Infinity marketplace interactions
 */

/**
 * Marketplace Contract ABI
 * Contains functions for purchasing Axies from the marketplace
 */
export const MARKETPLACE_ABI = [
  ...
  // Batch auction settlement (for sweeping)
  {
    "inputs": [
      {
        "internalType": "address",
...
/**
 * ERC20 Token ABI
 * Used for WETH token interactions (approvals, transfers, balance checks)
 */
export const ERC20_ABI = [
  ...
  // Check allowance (approved amount)
  {
    "inputs": [
      {
        "internalType": "address",
...
/**
 * ERC721 Token ABI
 * Used for Axie NFT interactions
 */
...
/**
 * Contract addresses for Ronin network
 */
