...
• /sweep - Start the sweeping process
...
• Select collection, quantity, and price parameters
• Preview and confirm purchases
• Execute bulk Axie purchases

*/balance*
• Check balances of all your wallets
• Shows RON, AXS, and SLP balances
...
• Regular Axies
    ...
    await ctx.editMessageText(message, {
      ...
      reply_markup: {
        inline_keyboard: [
          [Markup.button.callback('🧹 Start Sweeping Now', 'sweep:start')],
          [Markup.button.callback('🔙 Back to Help Menu', 'help:menu')]
        ]
      }
    });
...
• Shows RON, AXS, and SLP for each wallet
...
*Q: How much RON do I need to sweep?*
...
• Ensure your active wallet has enough RON for the total cost plus gas
